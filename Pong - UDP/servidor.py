    ...
    def executar(self):
        ...
        while True:
            ...
            try:
                ...
                print(f'Posição:{identificador_jogador}:{self.controle.posicao_atualizada_identificador(identificador_jogador)}')
                ...
                self.socket.enviar(self.controle.posicao_atualizada_identificador(identificador_jogador), endereco_jogador)
            except:
                break
