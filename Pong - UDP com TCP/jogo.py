...
import threading
from _thread import *
from socket_UDP_cliente import SocketUDPCliente
from socket_TCP_cliente import SocketTCPCliente
...
class Jogo:
    ...
    def __init__(self):
        ...
        self.socket = SocketUDPCliente("192.168.56.1", 5555)
        self.socket_placar = SocketTCPCliente("192.168.56.1", 6666)
