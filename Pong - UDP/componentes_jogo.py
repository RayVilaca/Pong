...
class Controle_Cliente:
    ...
    def descompactar_dados_antigo(self, dado):
        
        d = dado.split(",")
        self.prontos = int(float(d[1]))
        self.primeiro_jogador.x = int(float(d[2]))
        self.primeiro_jogador.y = int(float(d[3]))
        self.segundo_jogador.x = int(float(d[4]))
        self.segundo_jogador.y = int(float(d[5]))
        self.bola.x = int(float(d[6]))
        self.bola.y = int(float(d[7]))
        self.bola.x_velocidade = int(float(d[8]))
        self.bola.y_velocidadel = int(float(d[9]))
        self.pontuacao_primeiro_jogador = int(float(d[10]))
        self.pontuacao_segundo_jogador = int(float(d[11]))
...
class Controle_Servidor:
    ...
    def posicao_atualizada_identificador(self, identificador_jogador):
        return f'{identificador_jogador},{self.prontos},{self.primeiro_jogador.x},{self.primeiro_jogador.y},{self.segundo_jogador.x},{self.segundo_jogador.y},{self.bola.x},{self.bola.y},{self.bola.x_velocidade},{self.bola.y_velocidade},{self.pontuacao_primeiro_jogador},{self.pontuacao_segundo_jogador}'
